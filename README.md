# Olá! Eu sou o swords14 👋

## 🚀 Sobre mim

Desenvolvedor **Full Stack** apaixonado por tecnologia, sempre buscando criar soluções inovadoras e eficientes. Meu foco está em **JavaScript**, **TypeScript** e **Tailwind CSS**. Atualmente, estou dedicado ao desenvolvimento do meu projeto mais ambicioso:

### 🏆 Projeto em Destaque

- **[Éclat ERP](https://github.com/swords14/EclatErp)** — Sistema robusto para gestão empresarial. Venha acompanhar o progresso!
...
- Gamer nas horas vagas, especialmente **League of Legends**!
...
Curtiu algum projeto? Quer trocar ideia sobre tecnologia, games ou inovação? Fique à vontade para me chamar no email ou no Twitter!
